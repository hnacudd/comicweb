...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
            <div id="item-slide">
                <div class="title">
                    <h1>Sách Đề Cử <i class="fas fa-angle-right"></i></h1>
                </div>
                <!-- Flickity HTML init -->
                <div class="carousel" data-flickity='{ "autoPlay": true }'>
                    <div class="carousel-cell">
                        <c:forEach items="${list5B}" var="i">
                            <a href="detail?bid=${i.bookID}" id="carou-cell-a-link-book">                              
                                <div id="wrapper-carou-cell">
                                    <img src="${i.getImage()}" alt="" class="bg-carou-cell">
                                    <div id="name-carou-cell">
                                        ${i.getBookTitle()}
                                    </div>
                                </div>
                            </a>
                    ...
                    <!--Ph?i ?? 5 cái ?nh thì nó m?i ??y ra ?úng kích c? nhé-->
                    <div class="carousel-cell">
                        <c:forEach items="${list5B}" var="i">
                            <a href="detail?bid=${i.bookID}" id="carou-cell-a-link-book">                              
                                <div id="wrapper-carou-cell">
                ...
                <div class="title">
                    <h1>Sách mới <i class="fas fa-angle-right"></i></h1>
                </div>
                ...
                <nav aria-label="Page navigation example" class="page-pagination">
                    <ul class="pagination justify-content-center">
                        <c:if test="${tag > 1}">
                            <li class="page-item">
                                <a class="page-link " href="HomeController?index=${tag-1}"><i class="fas fa-angle-double-left"></i>Previous</a>
                            </li>
                        </c:if> 
                        <c:if test="${endP > 1 && endP >= tag}">
                            <c:forEach begin="1" end="${endP}" var="i">
                                ...
                                <c:if test="${tag < endP}">
                                <li class="page-item">
                                    <a class="page-link" href="HomeController?index=${tag+1}"><i class="fas fa-angle-double-right"></i>Next</a>
                                </li>
                            </c:if> 
                        </c:if>
