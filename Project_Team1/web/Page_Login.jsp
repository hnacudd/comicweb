<%-- 
    Document   : newjspPage_Login
    Created on : Dec 10, 2021, 10:23:15 AM
    Author     : long
--%>
        ...
        <div id="wrapper">
            <div id="signup-form">
                ...
                <div id="signup-form_content">
                    <form id="loginForm" class="form-login" action="LoginController" method="post" onsubmit="return checkForm()">
                        <div class="mb-3 vali">
                        ...
                        <c:if test="${wrongaccount != null}">
                            <p class="alert" style="color: red">${wrongaccount}</p>
                        </c:if>
